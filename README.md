...
![OpenQuantApp Dashboard](docs/images/dashboard.jpg)
...
开始提交前，请先阅读 [CONTRIBUTING.md](CONTRIBUTING.md)。其中包含开发环境、
代码规范、验证命令和 Pull Request 检查清单。
...
发现疑似安全漏洞时，请勿在公开 Issue 中披露细节，具体报告方式见
